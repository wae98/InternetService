            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <h3 class="card-title">
                                @can('personal.references.crear')
                                    <a class="btn btn-success" href="{{ route('references.create') }}"> Nueva Referencia </a>
                                @endcan
                            </h3>
                        </h3>
                    </div>
                            ...
                            <table id="references" class="table table-bordered table-striped" style="width: 100%" >
                                ...
                                @foreach ($references as $reference)
                                    <tr>
                                        ...
                                        <td> {{ $reference->customer->names }} </td>
                                        <td>
                                            <div class="grupo-botones">
                                                @can('personal.references.editar')
                                                    <div class="boton-warning">
                                                        <a class="btn btn-sm btn-primary"
                                                           href="{{ route('references.edit', $reference->id) }}"><i
                                                                class="fas fa-edit"></i></a>
                                                    </div>
                                                @endcan
                                                    @can('personal.references.visualizar')
                                                        <div class="boton-warning">
                                                            <a class="btn btn-sm btn-info"
                                                               href="{{ route('references.show', $reference->id) }}"><i
